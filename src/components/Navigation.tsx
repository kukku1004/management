...
const TABS: { key: TabKey; label: string; dividerBefore?: boolean }[] = [
  { key: 'tasks', label: '업적평가' },
  { key: 'matrix', label: '역량평가' },
  { key: 'results', label: '평가결과' },
  { key: 'notes', label: '개인면담', dividerBefore: true },
  { key: 'access', label: '권한관리' },
]
...
export default function Navigation({ role, activeTab, onTabChange, onOpenDataManagement, onOpenQuickStart }: NavigationProps) {
